...
const char HTTP_SAVED[] PROGMEM           = "<div>Credentials Saved<br />Trying to connect the Doorbell Modernizr to your network.<br />If it fails reconnect to \"Doorbell Modernizr\" access point to try again</div>";
